...
MemorySystem::MemorySystem(uint id, string deviceIniFilename = "ini/DDR3_micron_64M_8B_x4_sg15.ini" , string systemIniFilename="system.ini", string pwd="",
		string traceFilename = "unused") : 
	 ReturnReadData(NULL),
    WriteDataDone(NULL),
	systemID(0),
